...
import { applyTextLayoutsToDefinition } from '@/canvas/core/text/applyTextLayoutsToDefinition';
...
export function applyPatch(patchList = []) {
    ...
    useTemplateMasterStore.setState({ definition: applyTextLayoutsToDefinition(root) });
}
